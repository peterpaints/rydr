...
ActiveRecord::Schema.define(version: 2018_08_30_121919) do
  ...
  create_table "rides", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "vehicle_id"
    t.index ["departure_time", "vehicle_id"], name: "index_rides_on_departure_time_and_vehicle_id", unique: true
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.boolean "phone_on", default: false
    t.boolean "slack_on", default: false
